    ...
    if (r(8)) {
      var o = r(30),
        ...
        Tt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = d(c.length), o = At(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        jt = function() {
    ...
    var e,
      ...
      T = !!(function() {
        try {
          ...
          return (F || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== P.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      j = function(t) {
        var n;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), P = [], A = 1; A < b.length; A++) P.push(void 0 === (x = b[A]) ? x : String(x));
            var F = b.groups;
            if (p) {
    ...
    !(function(t) {
      WebViewer(
        ...
        var r = window.createStampTool(n),
          e = t.TriangleCreateToolFactory.initialize(n.Annotations, n.Tools, n.CoreControls),
          o = t.TriangleAnnotationFactory.initialize(n.Annotations, n.CoreControls);
