  ...
  function(t, n) {
    window.TriangleControlHandleFactory = {
      initialize: function(t, n) {
        ...
        return (
          ((r.prototype = new t.ControlHandle()).getDimensions = function(r, e, o) {
            var i = r.vertices[this.index].x,
              u = r.vertices[this.index].y,
              c = t.ControlHandle.handleWidth / o,
              f = t.ControlHandle.handleHeight / o;
            return (i -= 0.5 * c), (u -= 0.5 * f), new n.Math.Rect(i, u, i + c, u + f);
          }),
          (r.prototype.draw = function(t, n, r, e) {
          ...
          (r.prototype.move = function(t, r, e, o, i) {
            (t.vertices[this.index].x += r), (t.vertices[this.index].y += e);
            for (var u = Number.MAX_VALUE, c = -Number.MAX_VALUE, f = Number.MAX_VALUE, a = -Number.MAX_VALUE, s = 0; s < t.vertices.length; ++s) {
              var l = t.vertices[s];
              (u = Math.min(u, l.x)), (c = Math.max(c, l.x)), (f = Math.min(f, l.y)), (a = Math.max(a, l.y));
            }
            var h = new n.Math.Rect(u, f, c, a);
            return t.setRect(h), !0;
          }),
          r
        );
      },
