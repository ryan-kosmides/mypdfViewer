!(function(t) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        jt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = d(c.length), o = It(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
        ...
        Lt = {
          ...
          filter: function(t) {
            return At(this, J(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Ft(v, r) : jt.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              H(m !== Function.prototype ? I(y).concat(I(m)) : I(y), function(t) {
                t in v || h(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        I = P || S(y),
        A = y ? (_ ? S('entries') : I) : void 0,
        F = ('Array' == n && O.entries) || P;
      if (
        (F && (x = s(F.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? I : S('values'), keys: d ? I : S('keys'), entries: A }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var c = t[F]._b, a = u + t[j], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
  ...
  function(t, n, r) {
    ...
    j ||
      ((I = function(t) {
        v(this, I, 'Promise', '_h'), h(t), e.call(this);
        try {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), p.length), 0), P = [], I = 1; I < b.length; I++) P.push(void 0 === (x = b[I]) ? x : String(x));
            var A = b.groups;
            if (h) {
              var F = [E].concat(P, O, p);
              void 0 !== A && F.push(A);
              var M = String(n.apply(void 0, F));
            } else M = y(E, p, O, P, A, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                E = a(m, h ? p : p.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : S)), p.length)) === x) S = u(p, S, d);
              else {
  ...
  function(t, n) {
    ...
    var o = {
      ...
      i = new Server(),
      u = 'https://pdftron.s3.amazonaws.com/downloads/pl/demo-annotated.pdf';
    WebViewer({ path: '../../../lib', pdftronServer: 'https://demo.pdftron.com/', initialDoc: u, documentId: o[u] }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = null,
        r = t.docViewer,
        u = t.annotManager,
        c = document.getElementById('url'),
      ...
      if ('http://localhost:3000' === window.location.origin) {
        ...
        (s.onreadystatechange = function() {
          4 === s.readyState && 200 === s.status && (c.value = 'http://'.concat(s.responseText, ':3000/samples/annotation/realtime-collaboration/'));
        }),
          s.open('GET', '/ip', !0),
          s.send();
      } else (c.value = 'https://pdftron.com/samples/web/samples/annotation/realtime-collaboration/'), (c.value = 'https://pdfjs.express/samples/annotation/realtime-collaboration/');
      (a.onclick = function() {
        c.select(), document.execCommand('copy'), document.getSelection().empty();
      }),
        r.on('documentLoaded', function() {
          var t = r.getDocument().getDocumentId();
          i.selectDocument(t);
          var o = (function() {
              var t = e(
                  ...
                  return regeneratorRuntime.wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (t.next = 2), u.importAnnotCommand(n.val().xfdf);
                        case 2:
                          if (((r = t.sent), !(e = r[0]))) {
                            t.next = 9;
                            break;
                          }
                          return (t.next = 7), e.resourcesLoaded();
                        case 7:
                          (e.authorId = n.val().authorId), u.redrawAnnotation(e);
                        case 9:
                        case 'end':
                          return t.stop();
                      }
            ...
            a = function(t) {
              ...
              u.importAnnotCommand(n);
            },
            s = function(t) {
              f || (u.setCurrentUser(t), window.alert('Welcome back '.concat(t)), (f = !0));
            },
            l = function() {
              var t,
                r = window.prompt('Welcome! Tell us your name :)');
              r && ((t = r), u.setCurrentUser(t), i.updateAuthor(n, { authorName: t }));
            };
          i.bind('onAuthStateChanged', function(t) {
            t ? ((n = t.uid), i.checkAuthor(n, s, l), i.bind('onAnnotationCreated', o), i.bind('onAnnotationUpdated', c), i.bind('onAnnotationDeleted', a)) : i.signInAnonymously();
          });
        }),
        u.on(
          'annotationChanged',
          (function() {
            var t = e(
              regeneratorRuntime.mark(function t(r, e, o) {
                var c;
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        return (t.next = 4), u.exportAnnotCommand();
                      case 4:
                        (c = t.sent),
                          r.forEach(function(t) {
                            var r = null;
                            'add' === e
                              ? (t.InReplyTo && (r = u.getAnnotationById(t.InReplyTo).authorId || 'default'),
                                n && (t.authorId = n),
                                i.createAnnotation(t.Id, { authorId: n, parentAuthorId: r, xfdf: c }))
                              : 'modify' === e
                              ? (t.InReplyTo && (r = u.getAnnotationById(t.InReplyTo).authorId || 'default'), i.updateAnnotation(t.Id, { authorId: n, parentAuthorId: r, xfdf: c }))
                              : 'delete' === e && i.deleteAnnotation(t.Id);
                          });
                      case 6:
                      case 'end':
                        return t.stop();
        ...
        u.setPermissionCheckCallback(function(t, r) {
          return r.authorId === n;
        }),
        (document.getElementById('select').onchange = function(n) {
          var r = o[n.target.value];
          t.loadDocument(n.target.value, { documentId: r });
        });
    });
  },
]);
