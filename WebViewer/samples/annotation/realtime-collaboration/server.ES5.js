        ...
        Lt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = b(t, e);
            return new (R(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : b(n, e)) - o));
          },
        },
        kt = function(t, n) {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Mt(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, a),
                  w(r)
                    ? r instanceof X || 'ArrayBuffer' == (i = x(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), K(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      tt = function(t) {
        for (var n, r = R(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = R(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (f(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), K(this, t, E(1, r));
            };
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                E = f(b, p ? h : h.slice(x));
              if (null === E || (_ = l(c(b.lastIndex + (p ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
