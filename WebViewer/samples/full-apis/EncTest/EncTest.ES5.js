!(function(t) {
            ...
            ? ((v = r(function(t, r, e, o) {
                ...
                if (w(r)) {
                  ...
                  if (void 0 === o) {
                    ...
                    if ((u = y - h) < 0) throw H('Wrong length!');
                  } else if ((u = d(o) * n) + h > y) throw H('Wrong length!');
                  c = u / n;
                } else (c = g(r)), (i = new K((u = c * n)));
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new $(i) }); s < c; ) P(t, s++);
              })),
              (_ = v.prototype = E(Gt)),
              p(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (A && (x = s(A.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          O &&
          'values' !== O.name &&
          ((P = !0),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var P = String(b[0]), E = f(s(u(b.index), h.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var A = [P].concat(O, E, h);
              void 0 !== M && A.push(M);
              var j = String(n.apply(void 0, A));
            } else j = y(P, h, E, O, M, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                P = a(m, p ? h : h.slice(S));
              if (null === P || (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, d);
              else {
            ...
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, a, f, s, l, h, p, v, y, d, g, m, b, x, S, w, _, P, E, O;
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 17:
                            return (i = t.sent), (t.next = 20), i.get('Root');
                          case 20:
                            return (u = t.sent), (t.next = 23), u.value();
                          case 23:
                            return (c = t.sent), (t.next = 26), c.get('Pages');
                          case 26:
                            return (a = t.sent), (t.next = 29), a.value();
                          case 29:
                            return (f = t.sent), (t.next = 32), f.get('Kids');
                          case 32:
                            return (s = t.sent), (t.next = 35), s.value();
                          case 35:
                            return (l = t.sent), (t.next = 38), l.getAt(0);
                          case 38:
                            return (h = t.sent), (t.next = 41), n.Filter.createURLFilter(e + 'my_stream.txt');
                          case 41:
                            return (p = t.sent), (t.next = 44), n.FilterReader.create(p);
                          case 44:
                            return (v = t.sent), (y = new n.Filter('0')), (t.next = 48), n.Filter.createFlateEncode(y);
                          case 48:
                            return (d = t.sent), (t.next = 51), o.createIndirectStreamFromFilter(v, d);
                          case 51:
                            return (g = t.sent), (t.next = 54), h.put('Contents', g);
                          case 54:
                            return (t.next = 56), n.SecurityHandler.createDefault();
                          case 56:
                            return (
                          ...
                          case 65:
                            (b = t.sent), saveBufferAsPDFDoc(b, 'secured.pdf'), (t.next = 74);
                            break;
                          case 69:
                            (t.prev = 69), (t.t0 = t.catch(4)), console.log(t.t0), console.log(t.t0.stack), (r = 1);
                          case 74:
                            return (t.prev = 74), console.log('Running Sample 2'), (x = o), (t.next = 79), x.initSecurityHandler();
                          case 79:
                            if (t.sent) {
                              t.next = 103;
                              break;
                          ...
                          case 84:
                            ...
                            return (P = w[_]), console.log("Trying password candidate: '" + P + "'"), (t.next = 89), x.initStdSecurityHandlerUString(P);
                          case 89:
                            if (!t.sent) {
                              t.next = 95;
                              break;
                            }
                            return (S = !0), console.log('The password is correct'), t.abrupt('break', 99);
                          case 95:
                          ...
                          case 103:
                            return x.lock(), console.log('PDF document initialized and locked'), (t.next = 107), x.getSecurityHandler();
                          case 107:
                            return (E = t.sent), (t.t1 = console), (t.next = 111), E.isUserPasswordRequired();
                          case 111:
                            return (t.t2 = t.sent), (t.t3 = 'Document Open Password: ' + t.t2), t.t1.log.call(t.t1, t.t3), (t.t4 = console), (t.next = 117), E.isMasterPasswordRequired();
                          case 117:
                            return (
                              (t.t5 = t.sent),
                          ...
                          case 184:
                            (O = t.sent), saveBufferAsPDFDoc(O, 'not_secured.pdf'), console.log('done'), (t.next = 193);
                            break;
                          case 189:
                            (t.prev = 189), (t.t37 = t.catch(74)), console.log(t.t37.stack), (r = 1);
                          case 193:
