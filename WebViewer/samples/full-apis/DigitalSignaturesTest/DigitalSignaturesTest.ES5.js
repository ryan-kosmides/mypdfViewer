          ...
          ''.split(/.?/).length
            ? function(t, n) {
                ...
                for (
                  ...
                  (o = s.call(g, i)) &&
                  !((u = g.lastIndex) > l && (a.push(i.slice(l, o.index)), o.length > 1 && o.index < i.length && p.apply(a, o.slice(1)), (c = o[0].length), (l = u), a.length >= h));

                )
                  g.lastIndex === o.index && g.lastIndex++;
                return l === i.length ? (!c && g.test('')) || a.push('') : a.push(i.slice(l)), a.length > h ? a.slice(0, h) : a;
              }
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                F = a(m, h ? p : p.slice(S));
              if (null === F || (_ = l(c(m.lastIndex + (h ? 0 : S)), p.length)) === b) S = u(p, S, d);
              else {
    ...
    (function(t) {
      ...
      var e = (function(t) {
        ...
        var v = Object.getPrototypeOf,
          d = v && v(v(F([])));
        d && d !== e && r.call(d, o) && (g = d);
        var y = (h.prototype = l.prototype = Object.create(g));
        function m(t) {
        ...
        function b(t, n) {
          ...
          return i
            ? i.done
              ? ((n[t.resultName] = i.value), (n.next = t.nextLoc), 'return' !== n.method && ((n.method = 'next'), (n.arg = void 0)), (n.delegate = null), f)
              : i
        ...
        return (
          ...
          (_.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: F(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), f;
            },
          }),
          t
        );
          ...
          u = (function() {
            var t = i(
              regeneratorRuntime.mark(function t(r, i) {
                var o, u, c, a, s, f, l, p, h, g, v, d, y, m, x, b, S, w, _, F;
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (t.next = 2), n.PDFDoc.createFromURL(r);
                      case 2:
                        return (
                      ...
                      case 8:
                        return (u = t.sent), (t.next = 11), u.addTrustedCertificateFromURL(i);
                      case 11:
                        return (t.next = 13), o.getDigitalSignatureFieldIteratorBegin();
                      case 13:
                        (c = t.sent), (a = !0);
                      case 15:
                      ...
                      case 42:
                        (t.t4 = t.sent), (t.t5 = 'Signature verification failed, objnum: ' + t.t4), t.t3.log.call(t.t3, t.t5), e('verification_status'), (a = !1);
                      case 46:
                      ...
                      case 109:
                        return (g = t.sent), (t.t25 = console), (t.next = 113), g.wasSuccessful();
                      case 113:
                        if (!t.sent) {
                          t.next = 117;
                          break;
                      ...
                      case 118:
                        return (t.t27 = t.t26), t.t25.log.call(t.t25, t.t27), (t.t28 = console), (t.next = 123), g.getResultString();
                      case 123:
                        return (t.t29 = t.sent), t.t28.log.call(t.t28, t.t29), (t.next = 127), g.getTimeOfTrustVerification();
                      case 127:
                        return (v = t.sent), (t.next = 130), g.getTimeOfTrustVerificationEnum();
                      case 130:
                        (t.t30 = t.sent),
                          (t.next =
                        ...
                        break;
                      case 133:
                        return console.log('Trust verification attempted with respect to current time (as epoch time):' + v), t.abrupt('break', 139);
                      case 135:
                        return console.log('Trust verification attempted with respect to signing time (as epoch time): ' + v), t.abrupt('break', 139);
                      case 137:
                        return console.log('Trust verification attempted with respect to secure embedded timestamp (as epoch time): ' + v), t.abrupt('break', 139);
                      case 139:
                        return (t.next = 141), g.getCertPath();
                      case 141:
                ...
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 7:
                        return (c = t.sent), (t.next = 10), n.TimestampingConfiguration.createFromURL('http://adobe-timestamp.globalsign.com/?signature=sha2');
                      case 10:
                      ...
                      case 23:
                        return (t.t0 = f), (t.next = 26), t.sent.annotPushBack(t.t0);
                      case 26:
                        return (t.next = 28), n.Image.createFromURL(u, i);
                      case 28:
                        return (l = t.sent), (t.next = 31), f.createSignatureAppearance(l);
                      case 31:
                        return console.log('Testing timestamping configuration.'), (t.next = 34), a.testConfiguration(s);
                      case 34:
                        return (p = t.sent), (t.next = 37), p.getStatus();
                      case 37:
                        if (!t.sent) {
                          t.next = 41;
                          break;
                        }
                        console.log('Success: timestamping configuration usable. Attempting to timestamp.'), (t.next = 71);
                        break;
                      case 41:
                        return (t.t1 = console), (t.next = 44), p.getString();
                      case 44:
                        return (t.t2 = t.sent), t.t1.log.call(t.t1, t.t2), (t.next = 48), p.hasResponseVerificationResult();
                      case 48:
                        if (!t.sent) {
                          t.next = 70;
                          break;
                        }
                        return (t.next = 51), p.getResponseVerificationResult();
                      case 51:
                        return (h = t.sent), (t.t3 = console), (t.next = 55), h.getCMSDigestStatusAsString();
                      case 55:
                        return (t.t4 = t.sent), (t.t5 = 'CMS digest status: ' + t.t4), t.t3.log.call(t.t3, t.t5), (t.t6 = console), (t.next = 61), h.getMessageImprintDigestStatusAsString();
                      case 61:
                        return (t.t7 = t.sent), (t.t8 = 'Message digest status: ' + t.t7), t.t6.log.call(t.t6, t.t8), (t.t9 = console), (t.next = 67), h.getTrustStatusAsString();
                      case 67:
                        (t.t10 = t.sent), (t.t11 = 'Trust status: ' + t.t10), t.t9.log.call(t.t9, t.t11);
                      case 70:
                        return t.abrupt('return', !1);
                      case 71:
                        return (t.next = 73), c.timestampOnNextSave(a, s);
                      case 73:
                        return (t.next = 75), u.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_incremental);
                      case 75:
                        return (g = t.sent), saveBufferAsPDFDoc(g, o), console.log('Timestamping successful. Adding LTV information for DocTimeStamp signature.'), (t.next = 80), c.verify(s);
                      case 80:
                        return (v = t.sent), (t.next = 83), c.enableLTVOfflineVerification(v);
                      case 83:
                        if (t.sent) {
                          t.next = 86;
                          break;
                      ...
                      case 86:
                        return (t.next = 88), u.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_incremental);
                      case 88:
          ...
          p = (function() {
            var t = i(
              regeneratorRuntime.mark(function t() {
                var e, i, p, h, g, v, d, y, m;
                return regeneratorRuntime.wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (e = 0), (t.prev = 1), (t.next = 4), n.PDFDoc.createFromURL(r + 'tiger.pdf');
                        case 4:
                          return (i = t.sent).initSecurityHandler(), i.lock(), (t.next = 9), i.createDigitalSignatureField('PDFTronApprovalSig');
                        case 9:
                          return (p = t.sent), (t.next = 12), n.SignatureWidget.createWithDigitalSignatureField(i, new n.Rect(300, 300, 500, 200), p);
                        case 12:
                          return (h = t.sent), (t.next = 15), i.getPage(1);
                        case 15:
                          return (g = t.sent), (t.next = 18), g.annotPushBack(h);
                        case 18:
                          return (t.next = 20), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                        case 20:
                          (v = t.sent), saveBufferAsPDFDoc(v, 'tiger_withApprovalField_output.pdf'), (t.next = 28);
                          break;
                        case 24:
                          (t.prev = 24), (t.t0 = t.catch(1)), console.log(t.t0), (e = 1);
                        case 28:
                          return (
                            (t.prev = 28),
                            (t.next = 31),
                            c(r + 'tiger_withApprovalField.pdf', 'PDFTronCertificationSig', r + 'pdftron.pfx', 'password', r + 'pdftron.bmp', 'tiger_withApprovalField_certified_output.pdf')
                          );
                        case 31:
                        ...
                        case 34:
                          ...
                          break;
                        case 36:
                          (t.prev = 36), (t.t1 = t.catch(28)), console.log(t.t1), (e = 1);
                        case 40:
                          return (
                            (t.prev = 40),
                            (t.next = 43),
                            a(
                              r + 'tiger_withApprovalField_certified.pdf',
                              'PDFTronApprovalSig',
                              r + 'pdftron.pfx',
                              'password',
                              r + 'signature.jpg',
                        ...
                        case 46:
                          ...
                          break;
                        case 48:
                          (t.prev = 48), (t.t2 = t.catch(40)), console.log(t.t2), (e = 1);
                        case 52:
                          return (
                            (t.prev = 52),
                            (t.next = 55),
                            s(r + 'tiger_withApprovalField_certified_approved.pdf', 'PDFTronCertificationSig', 'tiger_withApprovalField_certified_approved_certcleared_output.pdf')
                          );
                        case 55:
                        ...
                        case 58:
                          ...
                          break;
                        case 60:
                          (t.prev = 60), (t.t3 = t.catch(52)), console.log(t.t3), (e = 1);
                        case 64:
                          return (t.prev = 64), (t.next = 67), u(r + 'tiger_withApprovalField_certified_approved.pdf', r + 'pdftron.cer');
                        case 67:
                          if (t.sent) {
                            t.next = 69;
                            break;
                        ...
                        case 69:
                          ...
                          break;
                        case 71:
                          (t.prev = 71), (t.t4 = t.catch(64)), console.log(t.t4), (e = 1);
                        case 75:
                          return (t.prev = 75), (t.next = 78), o(r + 'tiger_withApprovalField_certified_approved.pdf', r + 'pdftron.cer');
                        case 78:
                          if (t.sent) {
                            t.next = 80;
                            break;
                        ...
                        case 80:
                          ...
                          break;
                        case 82:
                          (t.prev = 82), (t.t5 = t.catch(75)), console.log(t.t5), (e = 1);
                        case 86:
                          return (t.prev = 86), (t.next = 89), l(r + 'tiger.pdf', r + 'GlobalSignRootForTST.cer', r + 'signature.jpg', 'tiger_DocTimeStamp_LTV.pdf');
                        case 89:
                          if (t.sent) {
                            t.next = 91;
                            break;
                        ...
                        case 91:
                          ...
                          break;
                        case 93:
                          (t.prev = 93), (t.t6 = t.catch(86)), console.log(t.t6), (e = 1);
                        case 97:
                          e ? console.log('Tests FAILED!!!\n==========') : console.log('Tests successful.\n==========');
                        case 98:
                        case 'end':
                          return t.stop();
                      }
