!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), m = o(d), b = e(c, v, 3), x = u(m.length), S = 0, w = r ? h(n, x) : a ? h(n, 0) : void 0; x > S; S++)
          if ((p || S in m) && ((g = b((y = m[S]), S, d)), t))
            if (r) w[S] = g;
            else if (g)
              switch (t) {
                case 3:
    ...
    if (r(8)) {
      var o = r(30),
        ...
        jt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = g(c.length), o = Ot(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        kt = function() {
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, p) {
      ...
      if (i(d)) {
        for (h = c(t.length); h > b; b++) if ((g = n ? m(u((v = t[b]))[0], v[1]) : m(t[b])) === f || g === s) return g;
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, y, g, d) {
      ...
      return h(b, t), (w[t] = b), o(o.G + o.W + o.F * (b != m), w), d || y.setStrong(b, t, g), b;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? O : S('values'), keys: g ? O : S('keys'), entries: M }), d)) for (b in m) b in E || i(E, b, m[b]);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                P = a(m, h ? p : p.slice(S));
              if (null === P || (_ = l(c(m.lastIndex + (h ? 0 : S)), p.length)) === x) S = u(p, S, g);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var g,
        ...
        b = u[d],
        x = b && b.prototype;
      if (x && (x[s] || c(x, s, p), x[l] || c(x, l, d), (a[d] = p), m)) for (g in e) x[g] || i(x, g, e[g], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
            ...
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, a, f, s, l, p, h, v, y, g, d, m, b, x, S, w, _, P, E, F, O, M, A;
                  return regeneratorRuntime.wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return console.log('Beginning Test'), (r = '../TestFiles/'), (e = null), (t.prev = 3), (t.next = 6), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 6:
                            return (o = t.sent).initSecurityHandler(), o.lock(), console.log('PDF document initialized and locked'), (t.next = 12), o.getPageCount();
                          case 12:
                          ...
                          case 16:
                            ...
                            return (t.next = 19), n.PDFDoc.create();
                          case 19:
                            return (
                              (a = t.sent),
                          ...
                          case 31:
                            ...
                            break;
                          case 33:
                            (t.prev = 33), (t.t0 = t.catch(3)), console.log(t.t0.stack);
                          case 36:
                            return (t.prev = 36), (t.next = 39), n.startDeallocateStack();
                          case 39:
                            return (t.next = 41), n.PDFDoc.create();
                          case 41:
                          ...
                          case 46:
                            ...
                            return (h = e[p - 1]), (t.next = 50), h.getPageCount();
                          case 50:
                          ...
                          case 52:
                            ...
                            break;
                          case 55:
                            return (t.next = 57), l.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 57:
                            return (y = t.sent), saveBufferAsPDFDoc(y, 'newsletter_merged.pdf'), (t.next = 61), n.endDeallocateStack();
                          case 61:
                            t.next = 66;
                            break;
                          case 63:
                            (t.prev = 63), (t.t1 = t.catch(36)), console.log(t.t1.stack);
                          case 66:
                            return (t.prev = 66), (t.next = 69), n.startDeallocateStack();
                          case 69:
                            return console.log('Sample 3, delete every second page'), (t.next = 72), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 72:
                            return (g = t.sent).initSecurityHandler(), g.lock(), (t.next = 77), g.getPageCount();
                          case 77:
                            d = t.sent;
                          case 78:
                            if (!(d >= 1)) {
                            ...
                            return (t.next = 81), g.getPageIterator(d);
                          case 81:
                            (m = t.sent), g.pageRemove(m), (d -= 2), (t.next = 78);
                            break;
                          case 86:
                            return (t.next = 88), g.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 88:
                            return (b = t.sent), saveBufferAsPDFDoc(b, 'newsletter_page_removed.pdf'), (t.next = 92), n.endDeallocateStack();
                          case 92:
                            t.next = 97;
                            break;
                          case 94:
                            (t.prev = 94), (t.t2 = t.catch(66)), console.log(t.t2);
                          case 97:
                            return (t.prev = 97), (t.next = 100), n.startDeallocateStack();
                          case 100:
                            return console.log('Sample 4, Insert a page at different locations'), (t.next = 103), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 103:
                            return (x = t.sent).initSecurityHandler(), x.lock(), (t.next = 108), n.PDFDoc.createFromURL(r + 'fish.pdf');
                          case 108:
                            return (S = t.sent).initSecurityHandler(), S.lock(), (t.next = 113), S.getPageIterator(1);
                          case 113:
                            return (w = t.sent), (t.next = 116), x.getPageIterator(1);
                          case 116:
                            (_ = t.sent), (P = 1);
                          case 118:
                            return (t.next = 120), _.hasNext();
                          case 120:
                            if (!t.sent) {
                              t.next = 131;
                              break;
                            ...
                            return (t.t3 = x), (t.t4 = _), (t.next = 126), w.current();
                          case 126:
                          ...
                          case 128:
                            ...
                            break;
                          case 131:
                            return (t.next = 133), x.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 133:
                            return (E = t.sent), saveBufferAsPDFDoc(E, 'newsletter_page_insert.pdf'), console.log('done'), (t.next = 138), n.endDeallocateStack();
                          case 138:
                            t.next = 143;
                            break;
                          case 140:
                            (t.prev = 140), (t.t6 = t.catch(97)), console.log(t.t6.stack);
                          case 143:
                            return (t.prev = 143), (t.next = 146), n.startDeallocateStack();
                          case 146:
                            return console.log('Sample 5, replicate pages within a single document'), (t.next = 149), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 149:
                            return (F = t.sent).initSecurityHandler(), (t.next = 153), F.getPage(1);
                          case 153:
                            return (O = t.sent), (t.next = 156), F.getPageIterator(7);
                          case 156:
                            return (
                              (M = t.sent),
                              F.pageInsert(M, O),
                          ...
                          case 164:
                            return (A = t.sent), saveBufferAsPDFDoc(A, 'newsletter_page_clone.pdf'), console.log('done saving newsletter_page_clone.pdf'), (t.next = 169), n.endDeallocateStack();
                          case 169:
                            t.next = 174;
                            break;
                          case 171:
                            (t.prev = 171), (t.t7 = t.catch(143)), console.log(t.t7.stack);
                          case 174:
                          case 'end':
                            return t.stop();
                        }
