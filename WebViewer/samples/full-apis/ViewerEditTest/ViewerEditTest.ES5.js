                                        ...
                                        switch ((t.prev = t.next)) {
                                          ...
                                          case 18:
                                            (l = t.sent),
                                              ...
                                              (t.t0 = l),
                                              (t.next =
                                                t.t0 === o.Element.Type.e_image
                                                  ? 26
                                                  : t.t0 === o.Element.Type.e_inline_image
                                                  ? 26
                                      ...
                                      function(r) {
                                        for (;;)
                                          switch ((r.prev = r.next)) {
                                            case 0:
                                              return (e = 0), (r.prev = 1), (i = t).lock(), i.initSecurityHandler(), (r.next = 7), o.ElementWriter.create();
                                            case 7:
                                              return (u = r.sent), (r.next = 10), o.ElementReader.create();
                                            case 10:
                                              return (c = r.sent), (f = []), (r.next = 14), i.getPageCount();
                                            case 14:
                                              (a = r.sent), (s = 1);
                                            case 16:
                                              if (!(s <= a)) {
                                              ...
                                              return i.unlock(), (r.next = 20), o.finishOperation();
                                            case 20:
                                              return (r.next = 22), i.requirePage(s);
                                            case 22:
                                              return (r.next = 24), o.beginOperation();
                                            case 24:
                                              return i.lock(), (r.next = 27), i.getPage(s);
                                            case 27:
                                              return (l = r.sent), (r.next = 30), l.getSDFObj();
                                            case 30:
                                              return (h = r.sent), (r.next = 33), h.getObjNum();
                                            case 33:
                                              return (
                                                (p = r.sent), f.includes(p) || f.push(p), c.beginOnPage(l), u.beginOnPage(l, o.ElementWriter.WriteMode.e_replacement, !1), (r.next = 39), n(c, u, f)
                                              );
                                            case 39:
                                              u.end(), c.end(), console.log('page ' + s + ' finished editing'), s++, (r.next = 16);
                                              break;
                                            case 45:
                                              console.log('Done.'), (r.next = 52);
                                              break;
                                            case 48:
                                              (r.prev = 48), (r.t0 = r.catch(1)), console.log(r.t0.stack), (e = 1);
                                            case 52:
