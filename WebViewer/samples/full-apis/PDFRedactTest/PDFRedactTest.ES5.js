        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = f(m, p ? h : h.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, d);
              else {
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.prev = 1), (t.next = 4), n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf');
                          case 4:
                            return (r = t.sent).initSecurityHandler(), r.lock(), (e = []), (t.t0 = e), (t.t1 = n.Redactor), (t.next = 12), n.Rect.init(100, 100, 550, 600);
                          case 12:
                            return (t.t2 = t.sent), (t.next = 15), t.t1.redactionCreate.call(t.t1, 1, t.t2, !1, 'Top Secret');
                          case 15:
                            return (t.t3 = t.sent), t.t0.push.call(t.t0, t.t3), (t.t4 = e), (t.t5 = n.Redactor), (t.next = 21), n.Rect.init(30, 30, 450, 450);
                          case 21:
                            return (t.t6 = t.sent), (t.next = 24), t.t5.redactionCreate.call(t.t5, 2, t.t6, !0, 'Negative Redaction');
                          case 24:
                            return (t.t7 = t.sent), t.t4.push.call(t.t4, t.t7), (t.t8 = e), (t.t9 = n.Redactor), (t.next = 30), n.Rect.init(0, 0, 100, 100);
                          case 30:
                            return (t.t10 = t.sent), (t.next = 33), t.t9.redactionCreate.call(t.t9, 2, t.t10, !1, 'Positive');
                          case 33:
                            return (t.t11 = t.sent), t.t8.push.call(t.t8, t.t11), (t.t12 = e), (t.t13 = n.Redactor), (t.next = 39), n.Rect.init(100, 100, 200, 200);
                          case 39:
                            return (t.t14 = t.sent), (t.next = 42), t.t13.redactionCreate.call(t.t13, 2, t.t14, !1, 'Positive');
                          case 42:
                            return (t.t15 = t.sent), t.t12.push.call(t.t12, t.t15), (t.t16 = e), (t.t17 = n.Redactor), (t.next = 48), n.Rect.init(300, 300, 400, 400);
                          case 48:
                            return (t.t18 = t.sent), (t.next = 51), t.t17.redactionCreate.call(t.t17, 2, t.t18, !1, '');
                          case 51:
                            return (t.t19 = t.sent), t.t16.push.call(t.t16, t.t19), (t.t20 = e), (t.t21 = n.Redactor), (t.next = 57), n.Rect.init(500, 500, 600, 600);
                          case 57:
                            return (t.t22 = t.sent), (t.next = 60), t.t21.redactionCreate.call(t.t21, 2, t.t22, !1, '');
                          case 60:
                            return (t.t23 = t.sent), t.t20.push.call(t.t20, t.t23), (t.t24 = e), (t.t25 = n.Redactor), (t.next = 66), n.Rect.init(0, 0, 700, 20);
                          case 66:
                            return (t.t26 = t.sent), (t.next = 69), t.t25.redactionCreate.call(t.t25, 3, t.t26, !1, '');
                          case 69:
                            return (t.t27 = t.sent), t.t24.push.call(t.t24, t.t27), (t.next = 73), n.ColorPt.init(0.1, 0.2, 0.6, 0);
                          case 73:
                            return (o = t.sent), (t.next = 76), n.Font.create(r, n.Font.StandardType1Font.e_times_roman);
                          case 76:
                            return (
                              (i = t.sent),
                          ...
                          case 81:
                            (c = t.sent), saveBufferAsPDFDoc(c, 'redacted.pdf'), console.log('Done...'), (t.next = 89);
                            break;
                          case 86:
                            (t.prev = 86), (t.t28 = t.catch(1)), console.log(t.t28.stack);
                          case 89:
                          case 'end':
                            return t.stop();
                        }
