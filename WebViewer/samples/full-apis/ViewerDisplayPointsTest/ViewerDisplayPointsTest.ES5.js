!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), m = o(d), x = e(c, v, 3), b = u(m.length), S = 0, w = r ? h(n, b) : a ? h(n, 0) : void 0; b > S; S++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = g(c.length), o = Mt(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        kt = function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? M : S('values'), keys: g ? M : S('keys'), entries: F }), d)) for (x in m) x in P || i(P, x, m[x]);
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n) {
        x(t);
        for (var r, e = d((n = w(n))), o = 0, i = e.length; i > o; ) H(t, (r = e[o++]), n[r]);
        return t;
      },
      Z = function(t) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                E = a(m, h ? p : p.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : S)), p.length)) === b) S = u(p, S, g);
              else {
                        ...
                        y = (function() {
                          var t = e(
                            regeneratorRuntime.mark(function t(n, r, e, o) {
                              var u, c, a, f, l, p, h, y, g, d, m, x, b, S, w, _, E;
                              return regeneratorRuntime.wrap(function(t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                    ...
                                    case 59:
                                      return t.abrupt('break', 97);
                                    case 60:
                                      return (a = r[u]), ++u, (f = r[u]), ++u, (m = r[u]), ++u, (x = r[u]), ++u, (p = f), (h = l = a + m), (g = a), (d = y = f + x), (t.next = 76), e.mult(a, f);
                                    case 76:
                                      return (S = t.sent), (t.next = 79), e.mult(l, p);
                                    case 79:
                                      return (w = t.sent), (t.next = 82), e.mult(h, y);
                                    case 82:
                                      return (_ = t.sent), (t.next = 85), e.mult(g, d);
                                    case 85:
                              ...
                              return regeneratorRuntime.wrap(function(t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    ...
                                    case 48:
                                      return n.formBegin(), (t.next = 51), d(n);
                                    case 51:
                                ...
                                function(e) {
                                  for (;;)
                                    switch ((e.prev = e.next)) {
                                      ...
                                      case 26:
                                        return (y = e.sent), (b = new i.OCGContext(n)), h.beginOnPage(y, b), (e.next = 31), d(h);
                                      case 31:
                                        (x = e.sent), (u[o] = x), h.end();
                                      case 34:
                                        return (e.next = 36), c.getPage(o);
                                      case 36:
                                        return (y = e.sent), (b = new i.OCGContext(n)), (e.next = 40), g(x, v, c, y, o, s, a);
                                      case 40:
