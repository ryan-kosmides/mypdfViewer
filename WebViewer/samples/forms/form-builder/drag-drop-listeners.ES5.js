  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Lt = function() {
          return vt.apply(Nt ? ht.call(Ft(this)) : Ft(this), arguments);
        },
        Rt = {
          ...
          filter: function(t) {
            return It(this, J(Ft(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        kt = function(t, n) {
          return It(this, ht.call(Ft(this), t, n));
        },
        Dt = function(t) {
          Ft(this);
        ...
        Wt = function(t, n) {
          return Bt(t, (n = b(n, !0))) ? h(2, t[n]) : V(t, n);
        },
        Gt = function(t, n, r) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? Mt(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        P = F || S(y),
        I = y ? (_ ? S('entries') : P) : void 0,
        M = ('Array' == n && O.entries) || F;
      if (
        (M && (x = s(M.call(new t()))) !== Object.prototype && x.next && (a(x, w, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          F &&
          'values' !== F.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: I }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (I || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== F.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
      ...
      L = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                I ? E.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = I || R(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          I ? E.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      D = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      H = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || T(t, D, E(1, {})), (t[D][n] = !0)), K(t, n, r)) : T(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), K(this, t, E(1, r));
            };
      ...
      o = function() {
        ...
        (t += Date.now()),
          ...
          'sign' === e && '' !== t
            ...
            : 'check' === e && '' !== t
            ? r.addFormFieldAnnot('CHECK', t, '', o)
            : 'radio' === e && '' !== t && r.addFormFieldAnnot('RADIO', i, n, o);
      },
      i = function() {
        var t = document.getElementById('fieldType').value,
          n = document.getElementById('multiline');
        'text' !== t ? ((n.disabled = !0), (n.checked = !1)) : (n.disabled = !1), (document.getElementById('radioNote').hidden = 'radio' !== t);
      };
    ...
    u.addEventListener('click', o),
      u.addEventListener('dragstart', function(t) {
        ...
        var r = 'check' === document.getElementById('fieldType').value,
          e = 'radio' === document.getElementById('fieldType').value;
        (n.style.width = r || e ? '50px' : '250px'),
          (n.style.height = '50px'),
          ...
          t.dataTransfer.setDragImage(n, r || e ? 25 : 125, 25),
