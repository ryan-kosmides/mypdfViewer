!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), m = o(d), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? p(n, S) : f ? p(n, 0) : void 0; S > x; x++)
          if ((h || x in m) && ((g = b((y = m[x]), x, d)), t))
            if (r) w[x] = g;
            else if (g)
              switch (t) {
                case 3:
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = function() {
          return vt.apply(Nt ? ht.call(Ot(this)) : Ot(this), arguments);
        },
        Lt = {
      ...
      v(Gt, kt),
        p(Gt, yt, kt.values),
        v(Gt, { slice: Ct, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        It(Gt, 'buffer', 'b'),
        It(Gt, 'byteOffset', 'o'),
        It(Gt, 'byteLength', 'l'),
        It(Gt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof q || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Mt(v, r) : jt.call(v, r);
                  (i = r), (h = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                    if (y % n) throw Y('Wrong length!');
                    if ((u = y - h) < 0) throw Y('Wrong length!');
                  } else if ((u = g(o) * n) + h > y) throw Y('Wrong length!');
                  c = u / n;
                } else (c = d(r)), (i = new q((u = c * n)));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : x('values'), keys: g ? F : x('keys'), entries: P }), d)) for (b in m) b in E || i(E, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var c = t[M]._b, f = u + t[j], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
  ...
  function(t, n, r) {
    ...
    j ||
      ...
      (i = function() {
        var t = new e();
        (this.promise = t), (this.resolve = a(k, t, 1)), (this.reject = a(D, t, 1));
      }),
      (b.f = I = function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: A(0, !1) }))) : (i(t, D) || T(t, D, A(1, {})), (t[D][n] = !0)), X(t, n, r)) : T(t, n, r)
        );
      },
      $ = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
    ...
    Y ||
      (f(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), X(this, t, A(1, r));
            };
          return u && z && X(V, t, { configurable: !0, set: n }), q(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = Q),
      (P.f = nt),
      u && !r(30) && f(V, 'propertyIsEnumerable', Q, !0),
      (y.f = function(t) {
        return q(v(t));
      })),
    ...
    for (var ot = I(v.store), it = 0; ot.length > it; ) g(ot[it++]);
    c(c.S + c.F * !Y, 'Symbol', {
      for: function(t) {
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      R.prototype[k] || r(14)(R.prototype, k, R.prototype.valueOf),
      h(R, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            } else I = y(A, h, E, O, P, n);
            E >= w && ((x += h.slice(w, E) + I), (w = E + A.length));
          }
          return x + h.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                A = f(m, p ? h : h.slice(x));
              if (null === A || (_ = l(c(m.lastIndex + (p ? 0 : x)), h.length)) === S) x = u(h, x, g);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var g,
        ...
        b = u[d],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, d), (f[d] = h), m)) for (g in e) S[g] || i(S, g, e[g], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', initialDoc: '../../full-apis/TestFiles/contract.pdf' }, document.getElementById('viewer')).then(function(t) {
      ...
      var n = {},
        ...
        f = o.WidgetFlags,
        a = u.getFieldManager();
      (c.convertAnnotToFormField = function() {
        var t = u.getAnnotationsList(),
          e = [],
          i = [];
        return (
          t.forEach(function(t, n) {
            ...
            if ('' !== t.getCustomData('type')) {
              var l = new f();
              if ((t.getCustomData('flag').readOnly && l.set(f.READ_ONLY, !0), t.getCustomData('flag').multiline && l.set(f.MULTILINE, !0), e.push(t), 'TEXT' === t.getCustomData('type')))
                (s = new o.Forms.Field(t.getContents() + Date.now() + n, { type: 'Tx', value: t.getCustomData('value'), flags: l })), (c = new o.TextWidgetAnnotation(s));
              else if ('SIGNATURE' === t.getCustomData('type'))
                (s = new o.Forms.Field(t.getContents() + Date.now() + n, { type: 'Sig', flags: l })),
                  (c = new o.SignatureWidgetAnnotation(s, {
                    appearance: '_DEFAULT',
                    appearances: {
                      _DEFAULT: {
                        Normal: {
              ...
              else if ('CHECK' === t.getCustomData('type')) {
                l.set(f.EDIT, !0);
                var h = new o.Font({ name: 'Helvetica' });
                (s = new o.Forms.Field(t.getContents() + Date.now() + n, { type: 'Btn', value: 'Off', flags: l, font: h })),
                  (c = new o.CheckButtonWidgetAnnotation(s, { appearance: 'Off', appearances: { Off: {}, Yes: {} } }));
              } else {
                if ('RADIO' !== t.getCustomData('type')) return void u.deleteAnnotation(t, { imported: !1, force: !0 });
                l.set(f.RADIO, !0), l.set(f.NO_TOGGLE_TO_OFF, !0);
                var p = new o.Font({ name: 'Helvetica' }),
                  v = t.getCustomData('name'),
                  y = t.getCustomData('value');
                (s = a.getField(v || 'RadioButtonGroup')) || (s = new o.Forms.Field(v || 'RadioButtonGroup', { type: 'Btn', value: 'Off', flags: l, font: p })),
                  (c = new o.RadioButtonWidgetAnnotation(s, { appearance: 'Off', appearances: r({ Off: {} }, y || n, {}) }));
              }
              (c.PageNumber = t.getPageNumber()),
                (c.X = t.getX()),
                (c.Y = t.getY()),
                (c.rotation = t.Rotation),
                0 === t.Rotation || 180 === t.Rotation ? ((c.Width = t.getWidth()), (c.Height = t.getHeight())) : ((c.Width = t.getHeight()), (c.Height = t.getWidth())),
                (o.WidgetAnnotation.getCustomStyles = function(t) {
                  return t instanceof o.TextWidgetAnnotation
                    ? { 'background-color': '#a5c7ff', color: 'white', 'font-size': '20px' }
                    : t instanceof o.SignatureWidgetAnnotation
                    ? { border: '1px solid #a5c7ff' }
                    : void 0;
                }),
                o.WidgetAnnotation.getCustomStyles(c),
                u.addAnnotation(c),
                a.addField(s),
                i.push(c);
            }
          }),
          u.deleteAnnotations(e, { force: !0 }),
          u.drawAnnotationsFromList(i).then(function() {
            n = {};
          })
        );
      }),
        (c.addFormFieldAnnot = function(t, r, c, f) {
          var a = e.getZoom(),
            s = e.getDocument(),
            l = e.getDisplayModeManager().getDisplayMode(),
            h = l.getSelectedPages(n, n);
          if (!n.x || null != h.first) {
            var p = null !== h.first ? h.first : e.getCurrentPage(),
              v = s.getPageInfo(p),
              y = l.windowToPage(n, p),
              g = new o.FreeTextAnnotation();
            g.PageNumber = p;
            var d = 90 * e.getCompleteRotation(p);
            (g.Rotation = d),
              'CHECK' === t || 'RADIO' === t
                ? ((g.Width = 25 / a), (g.Height = 25 / a))
                : 270 === d || 90 === d
                ? ((g.Width = 50 / a), (g.Height = 250 / a))
                : ((g.Width = 250 / a), (g.Height = 50 / a)),
              (g.X = (y.x || v.width / 2) - g.Width / 2),
              (g.Y = (y.y || v.height / 2) - g.Height / 2),
              g.setPadding(new i.Math.Rect(0, 0, 0, 0)),
              g.setCustomData('name', r),
              g.setCustomData('type', t),
              g.setCustomData('value', c),
              g.setCustomData('flag', f),
              g.setContents(''.concat(r, '_').concat(t)),
              (g.FontSize = ''.concat(10 / a, 'px')),
              (g.FillColor = new o.Color(211, 211, 211, 0.5)),
              (g.TextColor = new o.Color(0, 165, 228)),
              (g.StrokeThickness = 1),
              (g.StrokeColor = new o.Color(0, 165, 228)),
              (g.TextAlign = 'center'),
              (g.Author = u.getCurrentUser()),
              u.deselectAllAnnotations(),
              u.addAnnotation(g, !0),
              u.redrawAnnotation(g),
              u.selectAnnotation(g),
              (n = {});
          }
        }),
        (c.setDropPoint = function(t) {
          n = { x: t.x, y: t.y };
        });
    });
  },
