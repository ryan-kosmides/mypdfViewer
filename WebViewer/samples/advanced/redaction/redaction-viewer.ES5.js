!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Vt, Ct),
        p(Vt, yt, Ct.values),
        v(Vt, { slice: kt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        It(Vt, 'buffer', 'b'),
        It(Vt, 'byteOffset', 'o'),
        It(Vt, 'byteLength', 'l'),
        It(Vt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t) {
        ...
        return !(this === U && i(G, t) && !i(V, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
      ...
      nt = function(t) {
        for (var n, r = t === U, e = T(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(U, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(V, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), $(this, t, E(1, r));
            };
          ...
          n.on('documentLoaded', function() {
            document.getElementById('apply-redactions').onclick = function() {
              t.showWarningMessage({
                ...
                onConfirm: function() {
                  return t.docViewer.getAnnotationManager().applyRedactions(), Promise.resolve();
                },
              });
            };
          }),
