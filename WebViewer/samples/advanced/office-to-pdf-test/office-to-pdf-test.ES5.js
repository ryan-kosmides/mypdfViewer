!(function(t) {
  ...
  function(t, n) {
    !(function(t) {
      var n = t.PDFNet,
        r = t.CoreControls;
      t.runOfficeToPDF = function(t, e) {
        n.initialize()
          .then(function() {
            return (
              (n = '../../files/' + t),
              (o = 'converted_'.concat(e, '.pdf')),
              r.office2PDFBuffer(n, { l: i }).then(function(t) {
                saveBufferAsPDFDoc(t, o), console.log('Finished downloading '.concat(o));
              })
            );
            var n, o, i;
          })
