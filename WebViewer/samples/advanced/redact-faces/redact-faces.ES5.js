!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Bt, Dt),
        p(Bt, yt, Dt.values),
        v(Bt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), K(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = R(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = R(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (f(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), K(this, t, E(1, r));
            };
          return u && q && K(G, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
  ...
  function(t, n) {
        ...
        var e = t.Annotations,
          ...
          u = r.map(function(n) {
            var r = n.box.x,
              ...
              a = [r, e + u],
              s = [r + o, e + u];
            return i(t.CoreControls.Math.Quad, a.concat(s, f, c));
          }),
          c = new e.RedactionAnnotation({ Quads: u });
        (c.Author = o.getCurrentUser()), (c.PageNumber = n), (c.StrokeColor = new e.Color(255, 0, 0, 1)), o.addAnnotation(c, !1), o.redrawAnnotation(c);
      }
    }
    function f(t, n) {
      return new Promise(function(r) {
        var o = t.docViewer.getDocument(),
          i = o.getPageInfo(n),
                    ...
                    return regeneratorRuntime.wrap(function(e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (e.next = 2), faceapi.detectAllFaces(o, new faceapi.SsdMobilenetv1Options({ minConfidence: 0.4, maxResults: 300 }));
                          case 2:
                            (i = e.sent), (f = faceapi.resizeResults(i, u)), c(t, n, f), r();
                          case 6:
                          case 'end':
                            return e.stop();
                        }
    ...
    faceapi.nets.ssdMobilenetv1.loadFromUri('https://pdftron.s3.amazonaws.com/downloads/pl/face-redaction-models'),
      WebViewer(
                ...
                return regeneratorRuntime.wrap(function(n) {
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        t.closeElements(['redact-faces-instructions-modal']),
                          (r = t.docViewer.getDocument()),
                          (e = r.getPageCount()),
                          (o = createProgress(e)),
                          (i = o.sendPageProcessing),
                          (u = o.showProgress),
                          (c = o.hideProgress),
                          u(),
                          (a = 1);
        ...
        t.docViewer.on('documentLoaded', function() {
          var n,
            e =
              ((n = r),
              {
                ...
                render: function() {
                  ...
                  t.classList.add('redact-faces-instructions');
                  var r = document.createElement('div');
                  r.innerHTML = "Click 'Redact Faces' button below to start face redaction process.";
                  var e = document.createElement('button');
                  return (e.innerHTML = 'Redact Faces'), e.addEventListener('click', n), t.appendChild(r), t.appendChild(e), t;
                },
              });
          t.setCustomModal(e), t.openElements(['redact-faces-instructions-modal']);
        });
      });
  },
]);
