        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                E = f(m, p ? h : h.slice(x));
              if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
        ...
        u = function(t, e, i, u, c) {
          o
            ? ((o = !1),
              ...
              t.docViewer.getAnnotationManager().deleteAnnotations(t.docViewer.getAnnotationManager().getAnnotationsList(), { imported: !0, force: !0 }),
              e.docViewer.getAnnotationManager().deleteAnnotations(e.docViewer.getAnnotationManager().getAnnotationsList(), { imported: !0, force: !0 }),
              (n = void 0),
              (r = void 0),
              c && c())
          ...
          o && u(t, c, l, a, s),
            e ||
              ...
              t.docViewer.getTool('AnnotationCreateArrow').on('annotationAdded', function(r) {
                n && t.docViewer.getAnnotationManager().deleteAnnotation(n, { imported: !1, force: !0 }), (r.ReadOnly = !0), (n = r), i(f);
              }),
              c.docViewer.getTool('AnnotationCreateArrow').on('annotationAdded', function(t) {
                r && c.docViewer.getAnnotationManager().deleteAnnotation(r, { imported: !1, force: !0 }), (t.ReadOnly = !0), (r = t), i(f);
              }),
